...
module.exports = function () {
    ...
    vorpal.command('authorize_guest <mac>', 'Authorize Guest')
    ...
    vorpal.command('unauthorize_guest <mac>', 'Deauthorize Guest')
        .option('-l, --location <location>', 'Location')
        //        .option('-d, --deviceId <deviceId>', 'Cloud Device Id')
        .option('-s, --site <site>', 'Site')
        .action(function (args, cb) {
    ...
    vorpal.command('kick_sta <mac>', 'Kick station off the network')
        .option('-l, --location <location>', 'Location')
        //        .option('-d, --deviceId <deviceId>', 'Cloud Device Id')
        .option('-s, --site <site>', 'Site')
        .action(function (args, cb) {
