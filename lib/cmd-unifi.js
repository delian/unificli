...
module.exports = function () {
    ...
    addCmd('create_vouchers <count>', 'Create new hotspot', function(unifi, args, cb) {
    ...
    addCmd('debug [debug]', 'Enable or disable debug', function(unifi, args, cb) {
        ...
        unifi.obj.debugging(args.debug);
        cb();
    });
    ...
    addCmd('test', 'Just a test', function(unifi, args, cb) {
        ...
        .option('-a, --a <a>', 'AAAA')
        .option('--pesho <pesho>', 'Pesho', function(input, cb) { cb(['1','2','3'])});
